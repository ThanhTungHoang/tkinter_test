...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        # tạo radiobuttons
        self.radio_1 = ttk.Radiobutton(self.radio_frame, text="Unselected", variable=self.var_3, value=1)
        self.radio_1.grid(row=0, column=0, padx=5, pady=10, sticky="nsew")
        self.radio_2 = ttk.Radiobutton(self.radio_frame, text="Selected", variable=self.var_3, value=2)
        ...
        self.entry.insert(0, "Entry") # giá trị text mặc định
        ...
        # ô read only combobox
        self.readonly_combo = ttk.Combobox(self.widgets_frame, state="readonly", values=self.readonly_combo_list)
        ...
        self.menu.add_separator() # phân cách
        self.menu.add_command(label="Menu item 3")
        self.menu.add_command(label="Menu item 4")

        # tạo menubutton
        self.menubutton = ttk.Menubutton(self.widgets_frame, text="Menubutton", menu=self.menu, direction="below")
        ...
        # tạo nút gạt đổi theme
        self.switch = ttk.Checkbutton(self.widgets_frame, text="Change dark-light", style="Switch.TCheckbutton", command=change_theme)
        self.switch.grid(row=10, column=0, padx=5, pady=10, sticky="nsew")
        ########################
        # panedwindow
        # tạo paned
        ...
        # Pane 1 chứa bảng giá chứa file
        self.treeview_frame = ttk.Frame(self.paned, padding=5)
        self.paned.add(self.treeview_frame, weight=1)
        # Treeview
        ...
        for file in entries:
            ...
            treeview_data.append((os.path.basename(path_file), os.path.splitext(file)[1], time.ctime(os.path.getmtime(path_file))))
        # Add file lên treeview
        for file in treeview_data:
            self.treeview.insert('', tk.END ,values = file)
        ...
        # Label
        self.label = ttk.Label(self.tab_1,text="Azure theme for ttk",justify="center",font=("-size", 15, "-weight", "bold"),)
...
if __name__ == '__main__':
    root = tk.Tk()
    root.title("")
    root.tk.call("source","C:/Users/thanhtung/Desktop/test/azure.tcl")
